...
include::clause_7-from_json_to_jsonld.adoc[]

include::clause_8-best-practices.adoc[]

include::clause_9-json-encoding.adoc[]

include::clause_10-rules-schemas.adoc[]

include::clause_11-rules-instances.adoc[]
