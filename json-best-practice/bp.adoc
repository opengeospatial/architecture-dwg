...
This document defines a [red]#draft# OGC Best Practice on a particular technology or approach related to an OGC standard. This document is [red]#not# an OGC Standard and may not be referred to as an OGC Standard. It is subject to change without notice.

//However, this document is an official position of the OGC membership on this particular technology topic.
...
include::clause_6-overview.adoc[]

include::clause_JSONBasicConsiderations.adoc[]

include::clause_7-JSONLDContextDocuments.adoc[]

include::clause_8-JSONSchema.adoc[]

include::clause_9-LinksinJSON.adoc[]

include::clause_10-rules-for-json-schema.adoc[]

include::clause_11-rules-for-json-ld.adoc[]
